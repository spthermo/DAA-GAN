# Implementation from https://github.com/godisboy/SN-GAN
# From paper "Spectral Normalization for Generative Adversarial Networks"
# SN-GAN

import torch.nn as nn
from layers.snlayers.snconv2d import SNConv2d
from layers.snlayers.snlinear import SNLinear
...
class SNResDiscriminator(nn.Module):
    def __init__(self, opt):
        ...
        ndlayers = 4
        self.res_d = self.make_model(opt.ndf, ndlayers)
        self.fc = SNLinear(opt.ndf*16, 1) # nn.Sigmoid() -- Replaced with Least Square Loss
